...
const AddEmployee=()=>{
    ...
    const handleSubmit =(e) =>{
        ...
        if(!firstName || !emailId || !lastName){
            toast.error("Please write all values")
        }
        else{
                addEmployee(state);
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className = "card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <button style={{margin:"10px"}} className="btn btn-info" onClick={handleSubmit}><FaSave/> Add</button>
                                    <button style={{margin:"10px"}} className="btn btn-danger" onClick={()=>{cancel()}} style={{marginLeft: "10px"}}><FaWindowClose/> Abort</button>
